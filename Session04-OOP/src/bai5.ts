class Student {
    ...
    constructor(_studentId:number, _studentName:string){
...
class Course {
    ...
    constructor(_courseId:number, _courseTitle:string){
...
class Enrollment {
    ...
    constructor(_student:Student,_course:Course,_scheduleTime:string){
...
class Main5{
    private _studyManager: StudyManager;
        ...
        while (running) {
            ...
            switch (choice) {
                case "1":
                    ...
                    if (studentName) this._studyManager.addStudent(studentName);
                    break;
                case "2":
                    const courseTitle = prompt("Enter course title: ");
                    if (courseTitle) this._studyManager.addCourse(courseTitle);
                    break;
                case "3":
                    ...
                    if (scheduleTime) this._studyManager.enrollStudent(studentId, courseId, scheduleTime);
                    break;
                case "4":
