class Book{
    ...
    constructor(_id:number, _title:string, _author:string, _year:number){
        this._id = _id;
        this._title = _title;
...
class LibraryManager {
    ...
    searchBook(title:string):void{
        this._book.forEach(function(element:Book, index:number){
            ...
            switch(choices3){
                ...
                case "3":
                    ...
                    if(!inputTitletoRemove){
                        ...
                        let idToRemove = this._LibraryManager.book.find((b:Book) => b.title == inputTitletoRemove)
                ...
                case "4":
                    ...
                    if(!inputTitleToSearch){
                        ...
                        let titleToSearch = this._LibraryManager.book.find((b:Book) => b.title == inputTitleToSearch)
